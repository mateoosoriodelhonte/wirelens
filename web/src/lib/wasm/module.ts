export interface WasmModule {
  ...
  wirelens_result_error_packet_number(handle: number): number | bigint;
...
export function adaptWasmModule(raw: RawWasmModule): WasmModule {
  ...
  return {
    ...
    wirelens_result_error_packet_number: functionExport(raw, 'wirelens_result_error_packet_number'),
