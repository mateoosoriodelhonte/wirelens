...
input limit is 64 MiB. This is a safety limit, not a performance claim.

## Quick start

Requirements are Node.js 22, pnpm 11.24.0, Python 3, CMake 4.4.2, Ninja
1.13.0, and Emscripten 6.0.8. The CMake and Ninja tools can be installed in a
