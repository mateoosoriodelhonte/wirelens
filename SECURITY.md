...
The parser treats capture bytes as hostile. It uses bounded reads and a 64 MiB
input cap. The normalized JSON contract excludes raw packet bytes. HTTP and
future exports must keep sensitive header values out of the model. A local-only
